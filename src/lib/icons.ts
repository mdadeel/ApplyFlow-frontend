...
export const AtSign = P.At
export const Award = P.Trophy
export const Bell = P.Bell
export const BellSlash = P.BellSlash
export const Bookmark = P.Bookmark
export const BookmarkSimple = P.BookmarkSimple
export const BookmarksSimple = P.BookmarksSimple
...
export const ChatCenteredDots = P.ChatCenteredDots
...
export const MessageCircle = P.ChatCircle
...
export const SlidersHorizontal = P.SlidersHorizontal
export const Upload = P.Upload
export const Users = P.Users
...
export const Handshake = P.Handshake
...
export const Newspaper = P.Newspaper
...
export const Send = P.PaperPlaneRight
export const Settings = P.Gear
export const ShareNetwork = P.ShareNetwork
