...
import { InterviewPrepCard } from '../components/features/InterviewPrepCard'
...
export function InterviewPrepPage() {
  ...
  return (
    <AppLayout>
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-end mb-lg">
      ...
      <div className="space-y-lg">
        {loading ? (
          ...
          <EmptyState
            ...
            description="Select an application and generate interview preparation materials."
          />
        )}
