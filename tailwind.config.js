  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'heading-1': ['24px', { lineHeight: '30px', letterSpacing: '-0.02em', fontWeight: '600' }],
        'heading-2': ['19px', { lineHeight: '26px', letterSpacing: '-0.01em', fontWeight: '600' }],
        'heading-3': ['17px', { lineHeight: '24px', letterSpacing: '-0.01em', fontWeight: '600' }],
